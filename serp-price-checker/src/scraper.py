...
def scrape_google_shopping(query: str, zenrows_api_key: str, wait_ms: int = 5000) -> str:
    """
    ...
    Args:
        ...
        wait_ms: Milisegundos de espera para JS rendering (default 5000)
    ...
    params = {
        ...
        "premium_proxy": "true",
        "proxy_country": "es",
        "wait": str(wait_ms),  # Esperar a que cargue JS
        "wait_for": ".sh-dgr__grid-result",  # Selector de productos Shopping (si existe)
    }
